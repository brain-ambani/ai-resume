  ...
  return (
    <header className="w-3/4 mx-auto mt-40">
      <div className="text-center flex flex-col items-center">
        ...
        <p className="text-center text-2xl w-1/2 mt-8 text-gray-400">
        ...
        <Button className="mt-4 text-2xl text-gray-100">Get Started</Button>
      </div>
      <div className="w-full border-4  my-8 flex items-center justify-center shadow-md rounded-md">
